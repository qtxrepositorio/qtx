...
class ExternalDocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reference_id' => ['type' => 'integer', 'length' => '10', 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_reference' => ['type' => 'foreign', 'columns' => ['reference_id'], 'references' => ['references_document', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
