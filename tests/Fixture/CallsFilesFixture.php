 ...
 *
 */
class CallsFilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'files' => ['type' => 'string', 'length' => '500', 'null' => true, 'default' => null, 'collate' => 'Latin1_General_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk_call_files_key' => ['type' => 'foreign', 'columns' => ['call_id'], 'references' => ['calls', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
