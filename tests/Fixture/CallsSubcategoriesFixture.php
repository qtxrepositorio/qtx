...
class CallsSubcategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sla' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null],
        ...
        '_constraints' => [
            ...
            'fk_category_key' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['calls_categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
