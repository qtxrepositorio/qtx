...
/**
 * CallsSubcategoriesFixture
 *
 */
class CallsSubcategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sla' => ['type' => 'time', 'length' => null, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null],
        'categorie_id' => ['type' => 'integer', 'length' => '10', 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_categorie_key' => ['type' => 'foreign', 'columns' => ['categorie_id'], 'references' => ['calls_categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
