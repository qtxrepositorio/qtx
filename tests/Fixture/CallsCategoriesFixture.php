...
/**
 * CallsCategoriesFixture
 *
 */
class CallsCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_area_key' => ['type' => 'foreign', 'columns' => ['area_id'], 'references' => ['calls_areas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
