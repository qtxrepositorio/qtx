...
document.getElementById("yearOne").value = JSON.parse( '<?php echo json_encode($yearOne) ?>' );
document.getElementById("yearTwo").value = JSON.parse( '<?php echo json_encode($yearTwo) ?>' );
...
//alert(JSON.parse( '<?php echo json_encode($yearTwo) ?>' ));
...
ctx = document.getElementById("lineChart");
    myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: JSON.parse( '<?php echo json_encode($yearOne) ?>' ),
                    fill: false,
                    lineTension: 0.1,
                ...
                {
                    label: JSON.parse( '<?php echo json_encode($yearTwo) ?>' ),
                    fill: false,
                    lineTension: 0.1,
