...
document.getElementById("dayInitial").value = JSON.parse( '<?php echo json_encode($dayInitial) ?>' );
document.getElementById("dayEnd").value = JSON.parse( '<?php echo json_encode($dayFinish) ?>' );
document.getElementById("month").value = JSON.parse( '<?php echo json_encode($month) ?>' );
document.getElementById("yearOne").value = JSON.parse( '<?php echo json_encode($yearTableOne) ?>' );
document.getElementById("yearTwo").value = JSON.parse( '<?php echo json_encode($yearTableTwo) ?>' );
document.getElementById("cc").value = JSON.parse( '<?php echo json_encode($cc) ?>' );
