                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        echo $this->Form->input('timecardEmployee', ['style'=>'width: 100%;','class'=>'form-control select2','multiple' => true,'options' => $listOfEmployeesNames, 'label' => 'Selecione o funcionário:']);
