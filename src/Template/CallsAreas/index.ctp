    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <div class="callsAreas index large-9 medium-8 columns content">
                <div align='right'>
                    <?php echo $this->Html->link(__('<i>Adicionar Área</i>'), array('action' => 'add'), array('class' => 'btn btn-success btn-xs', 'escape' => false)); ?>
                </div>
                <legend><?= __('Lista das áreas:') ?></legend>
                        ...
                        <?php foreach ($callsAreas as $callsArea): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'view', $callsArea->id), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle' => 'tooltip', 'title' => 'Visualizar')); ?>
