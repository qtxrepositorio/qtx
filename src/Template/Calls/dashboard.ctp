...
$labels_tech_resolved = [];
$count_tech_resolved = [];
foreach ($quantResolved as $key => $value) {
  # code...
  $labels_tech_resolved[] = $value['NAME'];
  $count_tech_resolved[] = $value['COUNT'];
}
...
<script>
    ...
    var labels_tech_resolved = JSON.parse( '<?php echo json_encode($labels_tech_resolved) ?>' );
    var count_tech_resolved = JSON.parse( '<?php echo json_encode($count_tech_resolved) ?>' );
            ...
            datasets: [
                {
                    ...
                    label: 'Solucionados',
                    data: count_tech_resolved,
                    backgroundColor: [
                        'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)',
                        'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)',
                        'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)',
                        'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)', 'rgba(59, 187, 83, 0.2)'
                    ],
                    borderColor: [
                        'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)',
                        'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)',
                        'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)',
                        'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)', 'rgba(59, 187, 83, 1)'
                    ],
